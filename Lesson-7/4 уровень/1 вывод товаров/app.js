...
let productsInDiv = document.querySelector(".products");
...
function clickHandler(event) {
    ...
    let producs = document.querySelector('.products');
    producs.innerHTML = ''
...
function showCategory(category) {
    ...
    switch (category) {
        case "phones":
            products.phones.forEach(function (product) {
                productsDiv += getProductMarkup(product);
            });
            productsInDiv.insertAdjacentHTML("afterbegin", productsDiv);
            break;
        case "tablets":
            products.tablets.forEach(function (product) {
                productsDiv += getProductMarkup(product);
            });
            productsInDiv.insertAdjacentHTML("afterbegin", productsDiv);
            break;
        case "tv":
            products.tv.forEach(function (product) {
                productsDiv += getProductMarkup(product);
            });
            productsInDiv.insertAdjacentHTML("afterbegin", productsDiv);
            break;
